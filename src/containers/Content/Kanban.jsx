...
const Kanban = () => {
  const { userViewState } = useContext(
    UserViewStateContext
  );
  const { groupBy, orderBy } =
    userViewState;
  ...
  return (
    <div className="content">
      <div className="grids">
        {Object.keys(
          groupedAndSorted.groupedTickets
        ).map((groupKey) => (
          <div key={groupKey}>
            <Label
              labelText={
